...
public class SignInFirebaseActivity extends BaseActivity implements
        GoogleApiClient.OnConnectionFailedListener,
        View.OnClickListener {

    private static final String TAG = "SignInFirebaseActivity";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (user != null) {
                    // com.example.tobim.profiltest.User is signed in
                    Log.d(TAG, "onAuthStateChanged:signed_in:" + user.getUid());
                } else {
                    // com.example.tobim.profiltest.User is signed out
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                    String user = userSnapshot.getValue().toString();
                    Log.d("ON CREATE ADDED", "Users: " + user);
                }
            }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(SignInFirebaseActivity.this, "Authentication failed.",
    ...
    private void signIn() {
        ...
        Log.d(TAG, "SIGN IN: " + FirebaseAuth.getInstance().getCurrentUser());
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
            ...
            writeNewUser(uid, name, email, String.valueOf(photoUrl));
            addUsertoList(new User(uid, name, email, String.valueOf(photoUrl)));
    ...
    private void writeNewUser (String userId, String name, String email, String photo) {
        ...
        myRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                for (DataSnapshot userSnapshot : dataSnapshot.getChildren()) {
                    String userString = userSnapshot.getValue().toString();
                    Log.d("ON WRITE ADDED", "Users: " + userString);
                    addUsertoList(user);
                }
            }
